...
- [ ] **Homepage below the frame still predates it** — "Why Digital Reform", 8 Benefits cards (6 without links, `src/pages/index.astro` Benefits section) and FAQ do not follow from the aging-Europe argument. Rewrite or cut so every block serves the frame. (High, 5)
