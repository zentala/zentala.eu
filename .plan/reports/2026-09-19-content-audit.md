...
## TLDR
Scanned 144 built routes, 55 content files, 242 links (18 unique external).
Found 29 links to draft pages, 12 links to missing pages, 6 dead external links, 9 orphan pages, 23 drafts.

## Links to draft pages (29) — 404 in production
...
| /docs/ideas/transportation/autonomous-transportation | src/content/docs/ideas/index.mdx:66 | src/content/docs/ideas/transportation/autonomous-transportation.mdx |
...
| /book/eGov-challenges | src/content/docs/index.mdx:41 | src/content/docs/book/eGov-challenges.mdx |
...
| /docs/book/egov-challenges | src/pages/docs/all.astro:152 | src/content/docs/book/eGov-challenges.mdx |
...
| /docs/ideas/transportation/autonomous-transportation | src/components/Footer.astro:40 | src/content/docs/ideas/transportation/autonomous-transportation.mdx |
...
| src/content/docs/book/european-egovernment.mdx | European eGovernment |
...
| src/content/docs/book/principles.md | Vision for European Cooperation and Integration |
...
| src/content/docs/ideas/governance/blockchain-state.mdx | Blockchain Open Source State (eGovernment) |
| src/content/docs/ideas/transportation/autonomous-transportation.mdx | Autonomous Transportation |
