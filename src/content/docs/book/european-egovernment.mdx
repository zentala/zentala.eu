...
description: "A shared digital government infrastructure for all EU member states, replacing 27 separate systems with one platform."
...
*This chapter describes the system. [The Total State](/book/the-total-state)
asks what such a system does to the balance of power, and what has to be built
alongside it so that citizens hold the state rather than the other way round.*
